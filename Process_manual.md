...
-------
    git clone https://github.com/vikash-kumar01/spring-cloud-kubernetes.git
             // https://github.com/trextozyne/Java_CI-CD_Sharelibrary.git
...
--------------
    docker build -t the-rexy/kubernetes-configmap-reload .
...
-----------
    docker push the-rexy/kubernetes-configmap-reload
